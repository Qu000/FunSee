//
//  JHCustomAnimateTransitionPush.m
//  FunSee
//
...
@interface JHCustomAnimateTransitionPush()

@property (nonatomic,strong)id<UIViewControllerContextTransitioning> transitionContext;


@end
@implementation JHCustomAnimateTransitionPush
...
-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    // 获取动画的源控制器和目标控制器
    JHBeautyViewController * fromVC = (JHBeautyViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    JHBeautyVideoViewController *toVC = (JHBeautyVideoViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
